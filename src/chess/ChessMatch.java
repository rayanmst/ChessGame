...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourceChess, ChessPosition targetChess) {
		Position source = sourceChess.toPosition();
		Position target = targetChess.toPosition();
	...
	private void validateSourcePosition(Position pos) {
		if (!board.thereIsAPiece(pos)) {
			throw new ChessException("Without piece in source position!");
		}
		if (currentPlayer != ((ChessPiece) board.piece(pos)).getColor()) {
			throw new ChessException("You only can move pieces of your color.");
		}
		if (!board.piece(pos).isThereAnyPossibleMove()) {
			throw new ChessException("There isn't no possible moves for this piece.");
		}
